		...
		<div class="steps">
			<ul class="items articles">
				<li class="item article">
					...
					<h3 itemprop="headline">Become a member</h3>
					<div class="description" itemprop="description">
						<p><a href="/login">Sign-up any time</a></p>
					</div>
				</li>
				<li class="item article">
					<div class="image"> 
					...
					<h3 itemprop="headline">Order a veggie bag</h3>
					<div class="description" itemprop="description">
						<p><a href="/butik">When you want</a></p>
					</div>
				</li>
				<li class="item article">
					<div class="image"> 
					...
					<h3 itemprop="headline">Pick up a week later</h3>
					<div class="description" itemprop="description">
						<p><a href="/afdelinger">See locations</a></p>
					</div>
				</li>
				<li class="item article">
					<div class="image"> 
					...
					<h3 itemprop="headline">Enjoy great food</h3>
					<div class="description" itemprop="description">
						<p><a href="/ugens-pose/<?= $weeklybag_item["sindex"] ?>">See this week's bag</a></p>
					</div>
				</li>
			</ul>
		</div>
